...
for(let i=1; i<=cantPelicula; i++){
    nombrePelicula = prompt(`Introduce el nombre de la pelicula n#: ${i}`);
    precioPelicula = parseInt(prompt(`Introduce el precio de la pelicula n#: $${i}`));
...
while(nombrePelicula2.toUpperCase() != "SALIR" ){
    ...
    console.log(`El valor por el momento es de: ${sumaTotal2}`);
